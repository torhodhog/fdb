    ...
    <div className="max-w-screen-lg mx-auto p-4">
      ...
      <div className="flex justify-center space-x-4 mb-10">
        <Image
          ...
          src="https://forsoker-ny-botte.s3.eu-north-1.amazonaws.com/fradisk.jpeg"
          alt="Fra disk"
          width={800} // Sett passende bredde
          height={600} // Sett passende høyde
        />
      ...
      <div className="text-center">
        ...
        <div className='flex justify-center mt-6 mb-6'>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1689.5323233399326!2d5.31726373790017!3d60.39484747942451!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x463cfd003f0fc121%3A0xcd4c7597e10f3c7c!2sfdb.343!5e1!3m2!1sno!2sno!4v1724075790058!5m2!1sno!2sno"
            width="600"
            height="450"
            style={{ border: "0" }}
