   ...
   return (
      <div className="relative flex lg:flex-row flex-col-reverse">
         <div className="relative w-full lg:block hidden mt-6" style={{ height: '600px' }}>
            <Image src="/herofredagen.png" alt="Hero Logo" layout="fill" objectFit="cover" />
         </div>
         <div className="relative w-full pl-0 pr-0 block lg:hidden" style={{ height: '100vh' }}>
            <Image src="/langfredagen.png" alt="Hero Logo Mobile" layout="fill" objectFit="cover" objectPosition="top" />
            <Link href="/products">
