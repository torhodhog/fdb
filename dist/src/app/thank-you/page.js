...
const ThankYouPage = async ({ searchParams }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("main", { className: "relative lg:min-h-full", children: [(0, jsx_runtime_1.jsx)("div", { className: "hidden lg:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12", children: (0, jsx_runtime_1.jsx)(image_1.default, { fill: true, src: "/checkout-thank-you.jpg", className: "h-full w-full object-cover object-center", alt: "thank you for your order" }) }), (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)("div", { className: "mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24", children: (0, jsx_runtime_1.jsxs)("div", { className: "lg:col-start-2", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-sm font-medium text-blue-600", children: "Kj\u00F8p fullf\u00F8rt" }), (0, jsx_runtime_1.jsx)("h1", { className: "mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl", children: "Takk for din bestilling" }), order._isPaid ? ((0, jsx_runtime_1.jsxs)("p", { className: "mt-2 text-base text-muted-foreground", children: ["Kvittering vil bli sendt til", " ", typeof order.user !== "string" ? ((0, jsx_runtime_1.jsx)("span", { className: "font-medium text-gray-900", children: order.user.email })) : null, ". Ta kontakt med oss hvis du har noen sp\u00F8rsm\u00E5l rundt ditt kj\u00F8p."] })) : ((0, jsx_runtime_1.jsx)("p", { className: "mt-2 text-base text-muted-foreground", children: "Vi setter pris p\u00E5 bestillingen din og behandler den n\u00E5. Bare vent litt, s\u00E5 sender vi deg en bekreftelse veldig snart!" })), (0, jsx_runtime_1.jsxs)("div", { className: "mt-16 text-sm font-medium", children: [(0, jsx_runtime_1.jsx)("div", { className: "text-muted-foreground", children: "Order nr." }), (0, jsx_runtime_1.jsx)("div", { className: "mt-2 text-gray-900", children: order.id }), (0, jsx_runtime_1.jsx)("ul", { className: "mt-6 divide-y divide-gray-200 border-t border-gray-200 text-sm font-medium text-muted-foreground", children: products.map((product) => {
                                        ...
                                        }) }), (0, jsx_runtime_1.jsxs)("div", { className: "space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-muted-foreground", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex justify-between", children: [(0, jsx_runtime_1.jsx)("p", { children: "Delsum:" }), (0, jsx_runtime_1.jsx)("p", { className: "text-gray-900", children: (0, utils_1.formatPrice)(orderTotal) })] }), deliveryFee > 0 && ((0, jsx_runtime_1.jsxs)("div", { className: "flex justify-between", children: [(0, jsx_runtime_1.jsx)("p", { children: "Levering" }), (0, jsx_runtime_1.jsx)("p", { className: "text-gray-900", children: (0, utils_1.formatPrice)(deliveryFee) })] })), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-base", children: "Totalt" }), (0, jsx_runtime_1.jsx)("p", { className: "text-base", children: (0, utils_1.formatPrice)(totalWithDelivery) })] })] }), (0, jsx_runtime_1.jsx)(Paymentstatus_1.default, { isPaid: order._isPaid || false, orderEmail: order.user.email, orderId: order.id }), (0, jsx_runtime_1.jsx)("div", { className: "mt-16 border-t border-gray-200 py-6 text-right", children: (0, jsx_runtime_1.jsx)(link_1.default, { href: "/products", className: "text-sm font-medium text-blue-600 hover:text-blue-500", children: "Fortsett \u00E5 handle \u2192" }) })] })] }) }) })] }));
};
