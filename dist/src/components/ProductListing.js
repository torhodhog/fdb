    ...
    if (isVisible && product) {
        return ((0, jsx_runtime_1.jsx)("div", { className: (0, utils_1.cn)("relative w-full cursor-pointer group/main", {
                "animate-in fade-in-5 slide-in-from-top-8": isVisible,
                                    ...
                                    }) }) }), (0, jsx_runtime_1.jsxs)("div", { className: "absolute bottom-1 sm:bottom-2 right-1 sm:right-2 z-10 bg-white dark:bg-gray-800 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full shadow-md flex items-center", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Heart, { className: "h-3 w-3 sm:h-4 sm:w-4 text-gray-500 dark:text-gray-400 mr-0.5 sm:mr-1" }), (0, jsx_runtime_1.jsx)("span", { className: "text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-200", children: favoriteCount })] })] }), (0, jsx_runtime_1.jsx)(link_1.default, { href: `/product/${product.id}`, onClick: () => setIsNavigating(true), className: (0, utils_1.cn)("block", {
                            "pointer-events-none opacity-70": isNavigating
                        }), children: (0, jsx_runtime_1.jsx)("h3", { className: "mt-2 sm:mt-4 font-medium text-xs sm:text-sm text-gray-700 dark:text-white line-clamp-2", children: product.name }) }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between mt-1 sm:mt-2", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-xs sm:text-sm text-gray-500 dark:text-white", children: product.size }), (0, jsx_runtime_1.jsx)("p", { className: "font-medium text-xs sm:text-sm text-gray-900 dark:text-white", children: (0, utils_1.formatPrice)(product.price) })] })] }) }));
    }
    return null;
};
