...
const InstallAppButton = () => {
    ...
    if (isInstalled) {
        return ((0, jsx_runtime_1.jsx)("button", { className: "flex items-center p-2 text-sm bg-green-100 text-green-800 rounded-full cursor-default", title: "App installert", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Check, { className: "h-4 w-4" }) }));
    }
    // Vis installasjon-knapp hvis tilgjengelig
    if (installPrompt) {
        return ((0, jsx_runtime_1.jsx)("button", { onClick: handleInstallClick, className: "flex items-center p-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-colors", title: "Installer appen p\u00E5 enheten din", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Download, { className: "h-4 w-4" }) }));
    }
    // Fallback for iOS Safari (som ikke støtter installPrompt)
    if (/iPad|iPhone|iPod/.test(navigator.userAgent)) {
        return ((0, jsx_runtime_1.jsxs)("div", { className: "relative", children: [(0, jsx_runtime_1.jsx)("button", { onClick: () => setShowIOSInstructions(!showIOSInstructions), className: "flex items-center p-2 text-sm bg-gray-600 hover:bg-gray-700 text-white rounded-full transition-colors", title: "Se hvordan du installerer p\u00E5 iOS", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Smartphone, { className: "h-4 w-4" }) }), showIOSInstructions && ((0, jsx_runtime_1.jsxs)("div", { className: "absolute top-full mt-2 right-0 bg-white border border-gray-200 rounded-lg p-4 shadow-lg z-50 w-64 text-sm text-gray-700", children: [(0, jsx_runtime_1.jsx)("div", { className: "font-semibold mb-2", children: "Installer p\u00E5 iOS:" }), (0, jsx_runtime_1.jsxs)("ol", { className: "list-decimal list-inside space-y-1", children: [(0, jsx_runtime_1.jsx)("li", { children: "Trykk Del-knappen (\u2B06\uFE0F) nederst" }), (0, jsx_runtime_1.jsx)("li", { children: "Scroll ned og velg \"Legg til p\u00E5 hjemmeskjermen\"" }), (0, jsx_runtime_1.jsx)("li", { children: "Trykk \"Legg til\" \u00F8verst til h\u00F8yre" })] }), (0, jsx_runtime_1.jsx)("button", { onClick: () => setShowIOSInstructions(false), className: "mt-3 text-blue-600 hover:text-blue-800 text-xs", children: "Lukk" })] }))] }));
    }
    // Vis alltid en knapp for testing (i utviklingsmodus)
    if (process.env.NODE_ENV === "development") {
        return ((0, jsx_runtime_1.jsx)("button", { onClick: () => {
                alert("PWA installering er tilgjengelig når siden er deployet med HTTPS.\n\nI production vil denne knappen la deg installere appen som en desktop/mobil app!");
            }, className: "flex items-center p-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-colors", title: "PWA installering (kun tilgjengelig i production)", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Download, { className: "h-4 w-4" }) }));
    }
