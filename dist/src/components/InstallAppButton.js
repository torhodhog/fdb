...
const InstallAppButton = () => {
    ...
    if (process.env.NODE_ENV === 'development') {
        return ((0, jsx_runtime_1.jsxs)("button", { onClick: () => {
            ...
            }, className: "flex items-center gap-2 px-3 py-2 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors", title: "PWA installering (kun tilgjengelig i production)", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Download, { className: "h-4 w-4" }), (0, jsx_runtime_1.jsx)("span", { className: "hidden sm:inline", children: "Installer app" })] }));
    }
