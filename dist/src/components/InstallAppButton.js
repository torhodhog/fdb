...
const InstallAppButton = () => {
    ...
    if (installPrompt) {
        return ((0, jsx_runtime_1.jsxs)("button", { onClick: handleInstallClick, className: "flex items-center gap-1 px-2 py-1.5 text-xs bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors", title: "Installer appen p\u00E5 enheten din", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Download, { className: "h-3 w-3" }), (0, jsx_runtime_1.jsx)("span", { className: "hidden sm:inline text-xs", children: "App" })] }));
    }
    // Fallback for iOS Safari (som ikke støtter installPrompt)
    if (typeof window !== 'undefined' && /iPad|iPhone|iPod/.test(navigator.userAgent)) {
        return ((0, jsx_runtime_1.jsxs)("div", { className: "relative", children: [(0, jsx_runtime_1.jsxs)("button", { onClick: () => setShowIOSInstructions(!showIOSInstructions), className: "flex items-center gap-1 px-2 py-1.5 text-xs bg-gray-600 hover:bg-gray-700 text-white rounded-md transition-colors", title: "Se hvordan du installerer p\u00E5 iOS", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Smartphone, { className: "h-3 w-3" }), (0, jsx_runtime_1.jsx)("span", { className: "hidden sm:inline text-xs", children: "App" })] }), showIOSInstructions && ((0, jsx_runtime_1.jsxs)("div", { className: "absolute top-full mt-2 right-0 bg-white border border-gray-200 rounded-lg p-4 shadow-lg z-50 w-64 text-sm text-gray-700", children: [(0, jsx_runtime_1.jsx)("div", { className: "font-semibold mb-2", children: "Installer p\u00E5 iOS:" }), (0, jsx_runtime_1.jsxs)("ol", { className: "list-decimal list-inside space-y-1", children: [(0, jsx_runtime_1.jsx)("li", { children: "Trykk Del-knappen (\u2B06\uFE0F) nederst" }), (0, jsx_runtime_1.jsx)("li", { children: "Scroll ned og velg \"Legg til p\u00E5 hjemmeskjermen\"" }), (0, jsx_runtime_1.jsx)("li", { children: "Trykk \"Legg til\" \u00F8verst til h\u00F8yre" })] }), (0, jsx_runtime_1.jsx)("button", { onClick: () => setShowIOSInstructions(false), className: "mt-3 text-blue-600 hover:text-blue-800 text-xs", children: "Lukk" })] }))] }));
    }
    // Vis alltid en knapp for testing (i utviklingsmodus)
    if (process.env.NODE_ENV === 'development') {
        return ((0, jsx_runtime_1.jsxs)("button", { className: "flex items-center gap-1 px-2 py-1.5 text-xs bg-orange-600 hover:bg-orange-700 text-white rounded-md transition-colors", title: "PWA ikke tilgjengelig i dev-mode", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Download, { className: "h-3 w-3" }), (0, jsx_runtime_1.jsx)("span", { className: "hidden sm:inline text-xs", children: "Dev" })] }));
    }
