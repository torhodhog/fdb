...
const ImageSlider = ({ urls }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "group relative bg-zinc-100 aspect-square overflow-hidden", children: [(0, jsx_runtime_1.jsxs)("div", { className: "absolute z-10 inset-0 opacity-0 group-hover:opacity-100 transition", children: [(0, jsx_runtime_1.jsx)("button", { onClick: (e) => {
                            e.preventDefault();
                            swiper?.slidePrev();
                        }, className: (0, utils_1.cn)(activeStyles, "left-3 transition", slideConfig.isBeginning ? inactiveStyles : ""), "aria-label": "Previous image", children: (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronLeft, { className: "h-4 w-4 text-zinc-700" }) }), (0, jsx_runtime_1.jsx)("button", { onClick: (e) => {
                            e.preventDefault();
                            swiper?.slideNext();
