...
const ProductSkeleton_1 = __importDefault(require("@/components/ProductSkeleton"));
const ProductReel = (props) => {
    ...
    if (isQueryLoading && isLoading) {
        return ((0, jsx_runtime_1.jsxs)("section", { className: "py-12", children: [(0, jsx_runtime_1.jsx)("div", { className: "md:flex md:items-center md:justify-between mb-4", children: (0, jsx_runtime_1.jsxs)("div", { className: "max-w-2xl px-4 lg:max-w-4xl lg:px-0", children: [(0, jsx_runtime_1.jsx)("h1", { className: "text-2xl font-bold text-gray-900 sm:text-3xl", children: title }), subtitle ? ((0, jsx_runtime_1.jsx)("p", { className: "mt-2 text-sm text-muted-foreground", children: subtitle })) : null] }) }), (0, jsx_runtime_1.jsx)("div", { className: "relative", children: (0, jsx_runtime_1.jsx)("div", { className: "mt-6 flex items-center w-full", children: (0, jsx_runtime_1.jsx)("div", { className: "w-full grid grid-cols-1 gap-y-10 sm:grid-cols-2 gap-x-6 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8", children: (0, jsx_runtime_1.jsx)(ProductSkeleton_1.default, { count: 8 }) }) }) })] }));
    }
    if (isError) {
