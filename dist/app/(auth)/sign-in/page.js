...
const Page = () => {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)("div", { className: "container relative flex pt-20 flex-col items-center justify-center lg:px-0", children: (0, jsx_runtime_1.jsxs)("div", { className: "mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col items-center space-y-2 text-center", children: [(0, jsx_runtime_1.jsx)(Icons_1.Icons.logo, { className: "h-20 w-20" }), (0, jsx_runtime_1.jsxs)("h1", { className: "text-2xl font-semibold tracking-tight", children: ["Logg inn p\u00E5 din ", isSeller ? "seller" : "", " konto"] }), (0, jsx_runtime_1.jsxs)(link_1.default, { className: (0, button_1.buttonVariants)({
                                    ...
                                    className: "gap-1.5",
                                                    ...
                                                    }), placeholder: "Password" }), errors?.password && ((0, jsx_runtime_1.jsx)("p", { className: "text-sm text-red-500", children: errors.password.message }))] }), (0, jsx_runtime_1.jsx)("div", { className: "text-center", children: (0, jsx_runtime_1.jsx)(link_1.default, { href: "/forgot-password", className: "text-sm text-red-600 hover:underline", children: "Glemt passord?" }) }), (0, jsx_runtime_1.jsxs)(button_1.Button, { disabled: isLoading, children: [isLoading && ((0, jsx_runtime_1.jsx)(lucide_react_1.Loader2, { className: "mr-2 h-4 w-4 animate-spin" })), "Logg inn"] })] }) }), (0, jsx_runtime_1.jsxs)("div", { className: "relative", children: [(0, jsx_runtime_1.jsx)("div", { "aria-hidden": "true", className: "absolute inset-0 flex items-center", children: (0, jsx_runtime_1.jsx)("span", { className: "w-full border-t" }) }), (0, jsx_runtime_1.jsx)("div", { className: "relative flex justify-center text-xs uppercase", children: (0, jsx_runtime_1.jsx)("span", { className: "bg-background px-2 text-muted-foreground", children: "fdb" }) })] }), isSeller ? ((0, jsx_runtime_1.jsx)(button_1.Button, { onClick: continueAsBuyer, variant: "secondary", disabled: isLoading, children: "Fortsett som kj\u00F8per" })) : null] })] }) }) }));
};
